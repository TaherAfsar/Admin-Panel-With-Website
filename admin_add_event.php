...
if(isset($_POST['add_event'])){
    ...
    $sql = "INSERT INTO events (name,date,image) VALUES('$name' ,'$date' , '$dst_db' ) ";
    ...
    <div class="content">
        ...
        <div class="div_deg">
            <form action="#" method="POST" enctype="multipart/form-data" class = "formdata" >
                ...
                <br>
                <div>
                    <input type="submit" value="Add Event" name="add_event" class="btn btn-primary" style="background-color: #2eca6a;">
                </div>
                </div>
            </form>
        </div>
