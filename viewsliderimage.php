...
if($_GET['slider_id']){
    ...
    $t_id = $_GET['slider_id'];
    $sql2 = "DELETE FROM imageslider WHERE id = '$t_id' ";
...
>
                ...
                <td class="table_td">
                    <?php echo "<a  onClick=\"javascript:return confirm('Are you sure you want to delete');\" class = 'btn btn-danger' href='viewsliderimage.php?slider_id={$info['id']}'>Delete</a>"
                    ?>
                </td>
